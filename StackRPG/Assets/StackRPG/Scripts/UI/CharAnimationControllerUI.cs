...
public class CharAnimationControllerUI : MonoBehaviour
{
    public enum eDir
    {
        DOWN,
        ...
        set
        {
            ...
            if (hasChanged)
            {
                if (m_charsetType == eCharSetType.RPG_Maker_XP)
                    TargetImage.sprite = m_spriteXpIdleFrames[(int)m_currentDir];
                else
                    TargetImage.sprite = m_spriteFrames[(int)((int)m_currentDir * AnimFrames)];
            }
        }
    }
    ...
    public void UpdateAnim(float dt)
    {
        ...
        TargetImage.sprite = GetCurrentSprite(CurrentDir);
    }
