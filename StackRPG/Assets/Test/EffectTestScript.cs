...
public class EffectTestScript : MonoBehaviour {
	...
	void Start ()
    {
        ...
        DOVirtual.Float(0, 1, 2, (_float) => { m_test = _float; unit.m_spriteRenderer.transform.position = new Vector3(0, DOVirtual.EasedValue(0, 3, m_test, Ease.InOutBounce)); }).OnComplete(()=> { Debug.Log("끝!"); });
